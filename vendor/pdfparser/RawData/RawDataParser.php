 ...
 */
namespace PTScannerVendor\Smalot\PdfParser\RawData;

use PTScannerVendor\Smalot\PdfParser\Config;
use PTScannerVendor\Smalot\PdfParser\Exception\EmptyPdfException;
use PTScannerVendor\Smalot\PdfParser\Exception\MissingPdfHeaderException;
class RawDataParser
{
    /**
     * @var Config
